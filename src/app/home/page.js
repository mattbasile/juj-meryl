...
export default function Home() {
  ...
  const hotels = [
    {
      ...
      copy: 'Enter 2904143 in Promo Code Section when booking.',
    },
    {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        'We will have parking available. But it’s a party so take an Uber.',
    },
    {
      question: 'Is anything happening Sunday?',
      answer:
        'You’ll probably be sick of us, so we’re sparing you brunch. Enjoy Boston.',
    },
  ];
    ...
    <div className="relative">
      ...
      >
        <div className="py-24 md:py-0 px-12 md:px-28 flex flex-col justify-center">
          ...
          <p className="text-sm leading-8 mt-6">
            Having family and friends to celebrate with us is the best gift of
            all, but if you wish to honor us with a wedding gift, we’ve compiled
            some ideas:
          </p>
        </div>
        <div className="h-[600px] md:h-full ">
          <a
            className="flex hover:bg-gold-500/90 transition-colors items-center justify-center w-full bg-gold-500 h-1/2 border-b border-gold-100"
            href=""
          >
            <img
              className="h-[32px] md:h-[70px]"
