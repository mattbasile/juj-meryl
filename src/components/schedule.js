...
export default function schedule({ userType }) {
  let VIPSchedule = [
    ...
    },
    {
      ...
      blurb:
        'Ceremony begins promptly at 5:30pm - please don’t show up on Juj time. We don’t think this needs any more description. Our only ask is that you bring it for the hora.',
    },
    {
      title: 'Afterparty',
